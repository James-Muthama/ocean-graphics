...
- **Jellyfish (x2)** — pulsing bell domes with animated waving tentacles
- **Starfish (x3)** — 5-point star polygons resting on the sea floor
- **Seaweed (x10)** — Bezier-curved plants that sway in the current
